 ...
 */
@WebServlet("/managerCat")
public class ManagerCat extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<Loai_Dong_Vat> list= loaiMeo_imp.getAllLoaiMeo();
		request.setAttribute("list", list);
		int isDog=0;
		List<DongVat> listDongVat= dongVat_imp.getAllDongVat(0);
		request.setAttribute("listDongVat", listDongVat);
		request.getRequestDispatcher("/view/CatManager.jsp").forward(request, response);
	}
