	...
	<div class="Dear">
		<div class="contain-wrap">
			...
			<div class="contain-login">
				<div class="title">
					<img class="imglogo" src='<c:url value="/img/PETSHOP.png"/>' alt=""> <span
						class="title-login"> PetShop Xin Chào !! </span>
				</div>
				<form class="av-form" action=' <c:url value="/j_security_check"/>' method="post">
				 <span id="note">${loi} </span>
					<input name="username" id="username" type="text" placeholder=" Nhập địa chỉ">
					<input name="password"id="password" type="password" placeholder="Nhập mật khẩu">
					<button name="login" value="Dangnhap" class="btn-DN">Đăng Nhập</button>
				</form>
				<div class="submit">
					<p>Remember me</p>
				...
				<p id="DK">
					Bạn chưa có tài khoản <a class="dkn" href="<c:url value="/j_security_check?code=signup"/>"> Đăng
						ký ngay</a>
				</p>
			</div>
		</div>
